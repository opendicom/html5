    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_date', models.DateTimeField(auto_now_add=True)),
                ('last_update', models.DateTimeField(auto_now=True)),
                ('name', models.CharField(choices=[('rad', 'Radiologo'), ('sol', 'Solicitante'), ('aut', 'Autenticador'), ('med', 'Medico'), ('res', 'Rest'), ('pac', 'Paciente')], max_length=3)),
        ...
        migrations.CreateModel(
            name='RoleType',
            fields=[
                ('id', models.BigAutoField(max_length=3, primary_key=True, serialize=False)),
                ('create_date', models.DateTimeField(auto_now_add=True)),
                ('last_update', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            name='UserViewerSettings',
            fields=[
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('create_date', models.DateTimeField(auto_now_add=True)),
                ('last_update', models.DateTimeField(auto_now=True)),
                ('viewer', models.CharField(blank=True, choices=[('cornerstone', 'Ver estudio'), ('zip', 'Descargar'), ('osirix', 'Osirix'), ('weasis', 'Weasis')], max_length=11, null=True)),
