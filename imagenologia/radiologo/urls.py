...
router.register(r'headscript', views.HeadscriptViewSet)
router.register(r'bodyscript', views.BodyscriptViewSet)
router.register(r'plantillaheader', views.PlantillaheaderViewSet)
router.register(r'plantillafooter', views.PlantillafooterViewSet)
